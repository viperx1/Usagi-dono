...
{
    // Create a tree widget with aired column (column 8)
    ...
    anime1->setText(8, aired1.toDisplayString());
    ...
    anime2->setText(8, aired2.toDisplayString());
    ...
    anime3->setText(8, aired3.toDisplayString());
    ...
    anime4->setText(8, aired4.toDisplayString());
    ...
    // Sort by aired column (column 8) in ascending order
    treeWidget.sortItems(8, Qt::AscendingOrder);
...
void TestMylistAiredSorting::testSortByStartDateDescending()
{
    ...
    // Sort by aired column (column 8) in descending order
    treeWidget.sortItems(8, Qt::DescendingOrder);

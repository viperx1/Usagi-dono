...
//    Debug("AniDBApi: ParseMessage: " + Message);
	...
	if(ReplyID == "200"){ // 200 {str session_key} LOGIN ACCEPTED
		...
		Debug(QString(__FILE__) + " " + QString::number(__LINE__) + " [AniDB Response] 217 MYLIST EXPORT QUEUED - Tag: " + Tag);
		...
		Debug(QString(__FILE__) + " " + QString::number(__LINE__) + " [AniDB Response] 218 MYLIST EXPORT CANCELLED - Tag: " + Tag);
		// Previous export was cancelled, likely because a new one was requested
	}
